...
var List = []Device {
		...
		Device{"2b001c001347343438323536","4361d138e70958ab716bd8ba3d20697c68a6061f" ,26.0023226,-100.5361814 ,"","","",""},					//17
...
func main() {
    ...
    File := filepath.Dir(ex)+"/Example.html"
	// log.Println(File)
	for i:=0;i<5;i++{
		parse(getData())
		// open.Start(File)
		if (!Opened){
			open.StartWith(File,"Chrome")
			Opened = true
		}
